...
insert into product(Pname, classification_kids, category, avaliação, size)
	   values('Fone de ouvido', false, 'Eletrônico', '4', null),
             ...
             ('Farinha de arroz', true, 'Alimentos', '2', null),
             ('Fire Stick Amazon', true, 'Eletrônico', '3', null);
             
-- idOrder, idOrderClient, ordersStatus, orderDescription, sendValue, paymentCash
insert into orders (idOrderClient, ordersStatus, orderDescription, sendValue, paymentCash) 
...
select concat(Fname,' ',Lname) as Client, idOrder as Request, ordersStatus as Status from clients c, orders o where c.idClient - idOrderClient;
