...
create table productOrder(	
    ...
    poStatus enum('Disponível','Sem estoque') default 'Dísponivel',    
...
create table productSupplier(
    ...
    constraint fk_product_supplier_suppplier foreign key (idPsSupplier) references supplier(idSupplier),
